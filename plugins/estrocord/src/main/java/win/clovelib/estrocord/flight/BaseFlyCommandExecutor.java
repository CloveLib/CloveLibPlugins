...
package win.clovelib.estrocord.flight;
...
public class BaseFlyCommandExecutor implements CommandExecutor {
    ...
    private final EstroMain estrocordPlugin;

    public BaseFlyCommandExecutor(BaseFlightMain flightMain, EstroMain estrocordPlugin) {
